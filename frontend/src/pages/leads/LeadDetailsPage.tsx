...
const LeadDetailsPage = () => {
  ...
  const { lead, loading, error, getLeadById, removeLead, resetSingleLead } = useLeads();
  ...
  if (error) return <ErrorMessage message={error} onRetry={() => id && getLeadById(id)} />;
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <Button variant="secondary" size="sm" onClick={() => navigate(`/leads/${lead._id}/edit`)}>
        ...
        <div className="p-6 grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-gray-900">{getSourceLabel(lead.source)}</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-gray-900">{formatDateTime(lead.createdAt)}</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-gray-900">{formatDateTime(lead.updatedAt)}</p>
            </div>
          </div>
        </div>
